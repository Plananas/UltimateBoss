using UltimateBoss.Content.Tiles;
using Terraria.ModLoader;
using Terraria.ID;
using Terraria.GameContent.Creative;

namespace UltimateBoss.Content.Items.Placeable
{
	public class MusicBox : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Assets/Music/Test"), ModContent.ItemType<MusicBox>(), ModContent.TileType<MusicBoxTile>());
		}
