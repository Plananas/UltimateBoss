...
namespace UltimateBoss.Content.NPCs.Bosses
{
	...
	public class ThanosGauntlet : ModNPC
	{
		...
		{
			return ModContent.NPCType<Bingus>();
		}

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Gauntlet of Bingus.");
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
		{
			...
			bestiaryEntry.Info.AddRange(new List<IBestiaryInfoElement> {
				...
				new FlavorTextBestiaryInfoElement("Gauntlet used by Bingus.")
			});
		}
